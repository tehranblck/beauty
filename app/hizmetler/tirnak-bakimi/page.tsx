...
const serviceDetails = {
    ...
    services: [
        {
            name: 'Manikür',
            description: 'El tırnaklarınız için kapsamlı bakım ve şekillendirme',
            price: '₺150\'den başlayan fiyatlarla',
            duration: '45-60 dakika',
        },
        {
            name: 'Pedikür',
            description: 'Ayak tırnaklarınız için profesyonel bakım ve şekillendirme',
        ...
        {
            name: 'Kalıcı Oje',
            description: 'Uzun süre dayanıklı ve parlak kalıcı oje uygulaması',
            price: '₺200\'den başlayan fiyatlarla',
            duration: '45-60 dakika',
        },
    ],
    benefits: [
        'Uzman tırnak teknisyenleri',
    ...
    extraInfo: `
        Tırnak bakımı hizmetlerimiz, deneyimli teknisyenlerimiz tarafından steril
        ortamda ve kaliteli ürünler kullanılarak gerçekleştirilmektedir. Her müşterimizin
        tırnak yapısı ve istekleri dikkate alınarak kişiye özel uygulamalar yapılmaktadır.
    `
};
                ...
                >
                    <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-2xl p-8 md:p-12">
                        <h3 className="text-2xl md:text-3xl font-serif mb-4">
                            Tırnak Bakımı İçin Randevu Alın
                        </h3>
                        <p className="mb-6">
                            Profesyonel tırnak bakımı ve tasarımı için hemen randevu alın.
                        </p>
