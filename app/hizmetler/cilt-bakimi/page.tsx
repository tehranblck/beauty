...
const serviceDetails = {
    ...
    services: [
        {
            name: 'Hydrafacial Bakım',
            description: 'Cildinizi derinlemesine temizleyen ve nemlendiren özel bakım',
            price: '₺450\'den başlayan fiyatlarla',
            duration: '60-75 dakika',
        },
        {
            name: 'Anti-Aging Bakım',
            description: 'Yaşlanma karşıtı özel serum ve maskeler ile gençlik aşısı',
            price: '₺600\'den başlayan fiyatlarla',
            duration: '90-120 dakika',
        },
        {
            name: 'Akne Bakımı',
            description: 'Problemli ciltler için özel formüllü bakım programı',
            price: '₺350\'den başlayan fiyatlarla',
            duration: '60-90 dakika',
        },
        {
            name: 'Medikal Cilt Bakımı',
            description: 'Cilt tipinize özel medikal ürünlerle profesyonel bakım',
            price: '₺500\'den başlayan fiyatlarla',
            duration: '75-90 dakika',
        },
    ],
    benefits: [
        'Uzman estetisyenler tarafından uygulama',
        'Dermokozmetik ürün kullanımı',
        'Cilt tipinize özel bakım programı',
        'Ücretsiz cilt analizi',
        'Steril ortam ve tek kullanımlık ürünler',
        'Modern cihazlar ile profesyonel bakım',
    ],
    extraInfo: `
    Cilt bakımı hizmetlerimiz, uzman estetisyenlerimiz tarafından en son teknoloji
    cihazlar ve profesyonel ürünler kullanılarak gerçekleştirilmektedir. Her müşterimize
    özel cilt analizi yapılarak, kişiye özel bakım programları oluşturulmaktadır.
  `
};
                ...
                >
                    <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-2xl p-8 md:p-12">
                        <h3 className="text-2xl md:text-3xl font-serif mb-4">
                            Cildinize Özel Bakım İçin Randevu Alın
                        </h3>
                        <p className="mb-6">
                            Ücretsiz cilt analizi ve size özel bakım programı için hemen randevu alın.
                        </p>
