...
const serviceDetails = {
    ...
    services: [
        {
            name: 'Gelin Makyajı',
            description: 'Özel gününüzde unutulmaz bir görünüm için profesyonel makyaj',
            price: '₺800\'den başlayan fiyatlarla',
            duration: '90-120 dakika',
        },
        {
            name: 'Özel Gün Makyajı',
            description: 'Davetler ve özel günler için şık ve kalıcı makyaj',
            price: '₺400\'den başlayan fiyatlarla',
            duration: '60-75 dakika',
        },
        {
            name: 'Kalıcı Makyaj',
            description: 'Kaş, dudak ve eyeliner için kalıcı makyaj uygulaması',
            price: '₺1000\'den başlayan fiyatlarla',
            duration: '120-180 dakika',
        },
        {
            name: 'Doğal Makyaj',
            description: 'Günlük kullanım için doğal ve zarif makyaj',
    ...
    benefits: [
        ...
        'Lüks ve kaliteli kozmetik ürünler',
        'Hijyenik uygulama ortamı',
        'Kişiye özel makyaj tasarımı',
        'Uzun süre kalıcı sonuçlar',
        'Ücretsiz makyaj danışmanlığı',
    ],
    extraInfo: `
        Makyaj hizmetlerimiz, deneyimli makyaj artistlerimiz tarafından en kaliteli
        kozmetik ürünler kullanılarak gerçekleştirilmektedir. Her müşterimizin yüz hatları
        ve ten rengi dikkate alınarak kişiye özel makyaj tasarımları yapılmaktadır.
    `
};
                ...
                >
                    <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-2xl p-8 md:p-12">
                        <h3 className="text-2xl md:text-3xl font-serif mb-4">
                            Profesyonel Makyaj İçin Randevu Alın
                        </h3>
                        <p className="mb-6">
                            Özel günleriniz ve günlük makyajınız için hemen randevu alın.
                        </p>
